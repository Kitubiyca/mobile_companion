...
class _ClassListState extends State<ClassList> {
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              FutureBuilder(
                  future: Hive.openBox<Class>('Classes'),
                  builder: (context, box) {
                    if (box.hasData) {
                      var classes = box.data as Box;
                      return Flexible(
                              ...
                              Container(
                                ...
                                child: InkWell(
                                  ...
                                  child: ListTile(
                                    ...
                                    title: Text(
                                      classes.getAt(index).name,
                                      style: const TextStyle(fontSize: 20),
                                    ),
                                    subtitle: Text(
                                      _getStringSavingChecks(classes.getAt(index)),
  ...
  String _getStringSavingChecks(Class cClass) {
    String str = "Основные характеристики: ";
    for (int i = 0; i < cClass.savingChecks.length; i++) {
      str += cClass.savingChecks.elementAt(i).getText() + ", ";
    }
  ...
  Widget _drawerElement(String name, String path) {
    return Container(
      ...
      child: InkWell(
        onTap: (){Hive.box<Class>("Classes").close();Navigator.pushReplacementNamed(context, path);},
        child: Center(
          child: Text(
            name,
            style: const TextStyle(fontSize: 20),
